...
![fleamarket_sample](https://user-images.githubusercontent.com/61574277/91686571-8f4d8500-eb98-11ea-8767-91a0030414ff.jpeg)
...
- DB設計
- 各モデルのアソシエーションの設定
- deviseを用いたログイン機能（バックサイド）
- ancestryを用いたカテゴリー機能（バックサイド）
- Payjpを用いたクレジットカード登録機能、商品購入機能（バックサイド）
- RSpecを用いたテスト

## サイトURL紹介
- ID:team1
- パスワード:A5112
- URL:[http://54.95.98.71/](http://54.95.98.71/)
